...
module.exports = {
    login: async (req, res) => {
        try {
            ...
            // cek apakah email tab ada di table user
            const user = await User.findOne({ where: { email: email } });
            // findOne mancari 1 data bukan berdasarkan primary key
            if (!user) {
